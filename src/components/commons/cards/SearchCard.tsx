...
const SearchCard: FC<{ product: Product }> = ({ product }) => {
    const navigation = useNavigation<any>()

    const handleDetails = () => { navigation.navigate("detail_du_produit", { product }) }
...
const styles = StyleSheet.create({
    container: { height: 150, marginVertical: 2, backgroundColor: colors.white, borderWidth: 0.5, borderColor: colors.main_light },
